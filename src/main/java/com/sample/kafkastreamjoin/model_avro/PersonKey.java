...
public class PersonKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 760775731897094816L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PersonKey\",\"namespace\":\"com.sample.kafkastreamjoin.model_avro\",\"fields\":[{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"id\",\"type\":\"int\"}]}");
   ...
   */
  public PersonKey(java.lang.String firstName, java.lang.String lastName, java.lang.Integer id) {
   ...
   */
  public static com.sample.kafkastreamjoin.model_avro.PersonKey.Builder newBuilder() {
    return new com.sample.kafkastreamjoin.model_avro.PersonKey.Builder();
  }
   ...
   * @return A new PersonKey RecordBuilder
   */
  public static com.sample.kafkastreamjoin.model_avro.PersonKey.Builder newBuilder(com.sample.kafkastreamjoin.model_avro.PersonKey.Builder other) {
    if (other == null) {
      return new com.sample.kafkastreamjoin.model_avro.PersonKey.Builder();
    } else {
      return new com.sample.kafkastreamjoin.model_avro.PersonKey.Builder(other);
    }
  }
   ...
   * @return A new PersonKey RecordBuilder
   */
  public static com.sample.kafkastreamjoin.model_avro.PersonKey.Builder newBuilder(com.sample.kafkastreamjoin.model_avro.PersonKey other) {
    if (other == null) {
      return new com.sample.kafkastreamjoin.model_avro.PersonKey.Builder();
    } else {
      return new com.sample.kafkastreamjoin.model_avro.PersonKey.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sample.kafkastreamjoin.model_avro.PersonKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sample.kafkastreamjoin.model_avro.PersonKey other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sample.kafkastreamjoin.model_avro.PersonKey.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sample.kafkastreamjoin.model_avro.PersonKey.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sample.kafkastreamjoin.model_avro.PersonKey.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sample.kafkastreamjoin.model_avro.PersonKey.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sample.kafkastreamjoin.model_avro.PersonKey.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sample.kafkastreamjoin.model_avro.PersonKey.Builder clearId() {
